...
![Supply-chain verification workflow](../assets/images/sdmts-supply-chain/sdmts-verification-workflow.png)

*Figure: Overview of the firm-level verification and supply-chain data-cleaning workflow.*

![Dashboard architecture](../assets/images/sdmts-supply-chain/sdmts-dashboard-architecture.png)

*Figure: Dashboard structure for translating supply-chain data into stakeholder-facing views.*

![Gap analysis framework](../assets/images/sdmts-supply-chain/sdmts-gap-analysis-framework.png)
