...
![Python and SQL workflow](../assets/images/python-sql-foundations/python-sql-workflow.png)

*Figure: Technical workflow connecting Python fundamentals, SQL querying, and later analytics coursework.*

![Python code preview](../assets/images/python-sql-foundations/python-code-preview.png)
